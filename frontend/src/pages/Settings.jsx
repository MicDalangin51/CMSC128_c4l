import { Row, Stack, Image, Container, Col, Tabs, Tab, Button, Table, Badge } from "react-bootstrap";
                            ...
                            <Table hover>
                                <tbody>
                                    {students.map(({ name }, index) => {
                                        return (
                                            <tr key={index}>
                                                <td> <Image src={"https://media.tarkett-image.com/large/TH_24567081_24594081_24596081_24601081_24563081_24565081_24588081_001.jpg"} width="45" height="45" className="me-2 img-fluid rounded-circle" />
                                                    {name}
